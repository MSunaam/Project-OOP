...
void Admin::createAccount() {
    ...
    loginFile.open("/Users/muhammadsunaam/Desktop/Project-OOP/Student/studentLogin.txt", ios::app); //opening login file in append mode
    if(loginFile.is_open()) {
...
void Admin::checkMarks() {
    ...
    cin >> loginId; //getting login id from user
    ifstream marks;
    marks.open("/Users/muhammadsunaam/Desktop/Project-OOP/Student/"+loginId+"student.txt"); //opening marks file
    if (marks.is_open()) {
        string line;
